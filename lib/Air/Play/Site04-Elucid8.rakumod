...
my $specification = external :href<https://raku.github.io/rakudoc>;
my $reference     = external :href<https://finanalyst.github.io>;
my $github        = external :href<https://github.com/orgs/elucid8-org/repositories>;
my $talk          = external :href<https://discord.gg/Bthw6vG8>;

my &index = &page.assuming(
    title => 'elucid',

    nav => nav(
        logo    => safe('<a href="/">elucid<b>=8</b></a>'),
...
site :theme-color<green>, :bold-color<red>,
 index
  main
   safe Q:to/END/;
